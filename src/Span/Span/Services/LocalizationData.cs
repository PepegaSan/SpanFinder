namespace Span.Services
{
    public partial class LocalizationService
    {
        internal static readonly (string key, string en, string ko, string ja, string zhHans, string zhHant, string de, string es, string fr, string ptBR)[] Entries =
        {
            ...
            ("Error_DeleteCancelled", "Delete cancelled", "삭제 취소됨", "削除がキャンセルされました", "删除已取消", "刪除已取消", "Löschen abgebrochen", "Eliminación cancelada", "Suppression annulée", "Exclusão cancelada"),
            ("Error_FileInUse", "File is in use by another program. Close it and try again.", "다른 프로그램에서 사용 중입니다. 프로그램을 종료한 후 다시 시도하세요.", "他のプログラムで使用中です。プログラムを終了してから再試行してください。", "文件正被其他程序使用。请关闭后重试。", "檔案正被其他程式使用。請關閉後重試。", "Datei wird von einem anderen Programm verwendet. Schließen Sie es und versuchen Sie es erneut.", "El archivo está en uso por otro programa. Ciérrelo e inténtelo de nuevo.", "Le fichier est utilisé par un autre programme. Fermez-le et réessayez.", "O arquivo está em uso por outro programa. Feche-o e tente novamente."),
            ("Error_FileInUseByProcess", "File is in use by: {0}. Close it and try again.", "다른 프로그램에서 사용 중: {0}. 프로그램을 종료한 후 다시 시도하세요.", "使用中: {0}。プログラムを終了してから再試行してください。", "文件正被以下程序使用: {0}。请关闭后重试。", "檔案正被以下程式使用: {0}。請關閉後重試。", "Datei wird verwendet von: {0}. Schließen Sie das Programm und versuchen Sie es erneut.", "El archivo está en uso por: {0}. Ciérrelo e inténtelo de nuevo.", "Fichier utilisé par : {0}. Fermez-le et réessayez.", "Arquivo em uso por: {0}. Feche-o e tente novamente."),
            ("Error_ReadOnlyFile", "File is read-only. Clear the read-only attribute and try again.", "읽기 전용 파일입니다. 읽기 전용 속성을 해제한 후 다시 시도하세요.", "読み取り専用ファイルです。属性を解除してから再試行してください。", "文件为只读。请清除只读属性后重试。", "檔案為唯讀。請清除唯讀屬性後重試。", "Datei ist schreibgeschützt. Entfernen Sie das Attribut und versuchen Sie es erneut.", "El archivo es de solo lectura. Quite el atributo e inténtelo de nuevo.", "Fichier en lecture seule. Supprimez l'attribut et réessayez.", "Arquivo somente leitura. Remova o atributo e tente novamente."),
            ("Error_ReadOnlyFolder", "Folder is read-only. Clear the read-only attribute and try again.", "읽기 전용 폴더입니다. 읽기 전용 속성을 해제한 후 다시 시도하세요.", "読み取り専用フォルダです。属性を解除してから再試行してください。", "文件夹为只读。请清除只读属性后重试。", "資料夾為唯讀。請清除唯讀屬性後重試。", "Ordner ist schreibgeschützt. Entfernen Sie das Attribut und versuchen Sie es erneut.", "La carpeta es de solo lectura. Quite el atributo e inténtelo de nuevo.", "Dossier en lecture seule. Supprimez l'attribut et réessayez.", "Pasta somente leitura. Remova o atributo e tente novamente."),
            ...
            ("Shortcut_CopyPath", "Copy path", "경로 복사", "パスをコピー", "复制路径", "複製路徑", "Pfad kopieren", "Copiar ruta", "Copier le chemin", "Copiar caminho"),
            ...
            ("Settings_NativeShellContextMenu", "Windows shell context menu", "Windows 셸 컨텍스트 메뉴", "Windowsシェルのコンテキストメニュー", "Windows Shell 上下文菜单", "Windows Shell 快顯功能表", "Windows-Shell-Kontextmenü", "Menú contextual de Windows Shell", "Menu contextuel Windows Shell", "Menu de contexto do Windows Shell"),
            ("Settings_NativeShellContextMenuDesc", "Explorer-style menu with copy path and favorites at the bottom. Off: Span flyout menu. Shift+right-click: legacy flyout.", "탐색기 스타일 메뉴(하단에 경로 복사·즐겨찾기). 끔: Span 플라이아웃. Shift+우클릭: 레거시.", "エクスプローラー形式（下部にパスコピー・お気に入り）。オフ: Spanフライアウト。Shift+右クリック: 従来メニュー。", "资源管理器风格菜单，底部含复制路径和收藏。关：Span 浮层。Shift+右键：旧菜单。", "檔案總管風格選單，底部含複製路徑與我的最愛。關閉：Span 浮動選單。Shift+右鍵：舊版選單。", "Explorer-Menü mit Pfad kopieren und Favoriten unten. Aus: Span-Flyout. Umschalt+Rechtsklick: altes Menü.", "Menú estilo Explorador con copiar ruta y favoritos abajo. Desactivado: flyout Span. Mayús+clic derecho: menú anterior.", "Menu style Explorateur avec copier le chemin et favoris en bas. Désactivé : flyout Span. Maj+Clic droit : ancien menu.", "Menu estilo Explorador com copiar caminho e favoritos no rodapé. Desligado: flyout Span. Shift+clique direito: menu antigo."),
